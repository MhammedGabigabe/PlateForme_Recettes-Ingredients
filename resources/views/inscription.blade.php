    ...
    <div class="flex flex-1 items-center justify-center p-6 bg-cream overflow-hidden">
        ...
        <div class="w-full max-w-[420px] bg-white p-8 rounded-2xl shadow-xl border border-sage/10">
            ...
            <div class="mb-6 text-center lg:text-left">
                ...
                <p class="text-sm text-sage">Connectez-vous pour continuer</p>
            </div>

            <!-- TOGGLE -->
            <div class="flex h-10 w-full bg-gray-100 rounded-xl p-1 mb-6 text-sm font-bold">
                <label class="flex-1 flex items-center justify-center cursor-pointer rounded-lg has-[:checked]:bg-white has-[:checked]:text-terracotta text-gray-500">
                    Se connecter
                    <input type="radio" name="auth" class="hidden">
                </label>
                <label class="flex-1 flex items-center justify-center cursor-pointer rounded-lg has-[:checked]:bg-white has-[:checked]:text-terracotta text-gray-500">
                    Créer un compte
                    <input type="radio" name="auth" checked class="hidden">
                </label>
            </div>
            ...
            <form class="space-y-5">
                ...
                <div class="space-y-3 pt-2">
                    ...
                    <button class="w-full h-12 border border-sage/30 text-sage font-bold rounded-xl text-sm hover:bg-sage/5">
                        Se connecter
                    </button>
                </div>
